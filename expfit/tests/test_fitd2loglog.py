...
class TestFitd2LogLog(unittest.TestCase):
    """
    Tests fitting of double exponentials with ``fitd2loglog``.
    """
    @classmethod
    def setUpClass(cls):
    ...
    def d2_on_double(self, a, b, c, d, e, duration=2, n=200, fnoise=0.01, t0=0,
        ...
        af, bf, cf, df, ef = expfit.fitd2loglog(t, v, plot=plot_params)
    ...
    def test_fitd2_edge_cases(self):
        ...
        y = np.zeros(x.shape)
        a, b, c, d, e = expfit.fitd2loglog(x, y)
