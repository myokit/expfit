...
class TestCI(unittest.TestCase):
    ...
    def test_profile(self):
        ...
        self.assertAlmostEqual(xx[1], -8.163763431014, delta=1e-12)
        self.assertAlmostEqual(xx[2], -5.489527400523, delta=1e-12)
        self.assertAlmostEqual(xx[3], -2.815291370031, delta=1e-12)

        self.assertEqual(len(yy), 5)
        self.assertAlmostEqual(yy[0], 304.636783317, delta=1e-9)
        self.assertAlmostEqual(yy[1], 299.200319779, delta=1e-9)
        self.assertAlmostEqual(yy[2], 297.388165267, delta=1e-9)
        self.assertAlmostEqual(yy[3], 299.200319782, delta=1e-9)
        self.assertAlmostEqual(yy[4], 304.636783324, delta=1e-9)
